...
2. Potentially different alignment and translation output due to changes in alignment algorithm. Some of the alignment parameters is removed.
...
#### Changed and removed some of the URL parameters
