...
- `muR`: mutation emission probability in the recombinant state. Defaults to the median substitution distance between clade founders (a tree-based proxy for inter-clade divergence).
