...
that have future-proof scalability"""
    ...
    def source(self):
        tools.get(url=self.src_url, sha256=self.src_sha256)
        os.rename("one{}-{}".format(self.name.upper(), self.version.upper()), self._source_subfolder)

        # Patch for Apple Silicon. Borrowed from Homebrew: https://github.com/Homebrew/homebrew-core/pull/57745/files
        url = "https://github.com/oneapi-src/oneTBB/commit/86f6dcdc17a8f5ef2382faaef860cfa5243984fe.diff?full_index=1"
        patch_file = "86f6dcdc17a8f5ef2382faaef860cfa5243984fe.diff"
