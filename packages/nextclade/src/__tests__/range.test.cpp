...
TEST(RangeIntersect, Empty_when_disjoint_left) {
  ...
  //       yy
  // 0123456789
  EXPECT_FALSE(intersection(Nextclade::Range{1, 4}, {6, 8}));
}
...
TEST(RangeIntersect, Empty_when_disjoint_right) {
  ...
  //       xx
  // 0123456789
  EXPECT_FALSE(intersection(Nextclade::Range{6, 8}, {1, 4}));
}
...
TEST(RangeIntersect, Empty_when_adjacent_left) {
  ...
  //     yyy
  // 0123456789
  EXPECT_FALSE(intersection(Nextclade::Range{1, 4}, {4, 7}));
}
...
TEST(RangeIntersect, Empty_when_adjacent_right) {
  ...
  //     xxx
  // 0123456789
  EXPECT_FALSE(intersection(Nextclade::Range{4, 7}, {1, 4}));
}
...
TEST(RangeIntersect, Overlap_one_left) {
  ...
  //    yyy
  // 0123456789
  EXPECT_EQ(std::make_pair(3, 4), intersection(Nextclade::Range{1, 4}, {3, 6}));
}
...
TEST(RangeIntersect, Overlap_one_right) {
  ...
  //    xxx
  // 0123456789
  EXPECT_EQ(std::make_pair(3, 4), intersection(Nextclade::Range{3, 6}, {1, 4}));
}
...
TEST(RangeIntersect, Overlap_many_left) {
  ...
  //    yyyyy
  // 0123456789
  EXPECT_EQ(std::make_pair(3, 6), intersection(Nextclade::Range{1, 6}, {3, 8}));
}
...
TEST(RangeIntersect, Overlap_many_right) {
  ...
  //    xxxxx
  // 0123456789
  EXPECT_EQ(std::make_pair(3, 6), intersection(Nextclade::Range{3, 8}, {1, 6}));
}
...
TEST(RangeIntersect, Equal) {
  ...
  //  yyyyy
  // 0123456789
  EXPECT_EQ(std::make_pair(1, 6), intersection(Nextclade::Range{1, 6}, {1, 6}));
}
