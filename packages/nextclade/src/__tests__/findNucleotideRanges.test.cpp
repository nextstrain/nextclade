...
TEST(FindNucleotideRanges, Single_Caracter_Begin) {
  ...
  const auto expected =
    std::vector<NucleotideRange>{NucleotideRange{.begin = 0, .end = 1, .length = 1, .character = Nucleotide::T}};
  EXPECT_ARR_EQ(expected, actual)
}
...
TEST(FindNucleotideRanges, Single_Caracter_Middle) {
  ...
  const auto expected =
    std::vector<NucleotideRange>{NucleotideRange{.begin = 5, .end = 6, .length = 1, .character = Nucleotide::T}};
  EXPECT_ARR_EQ(expected, actual)
}
...
TEST(FindNucleotideRanges, Single_Caracter_End) {
  ...
  const auto expected =
    std::vector<NucleotideRange>{NucleotideRange{.begin = 8, .end = 9, .length = 1, .character = Nucleotide::T}};
  EXPECT_ARR_EQ(expected, actual)
}
...
TEST(FindNucleotideRanges, One_Range) {
  ...
  const auto expected =
    std::vector<NucleotideRange>{NucleotideRange{.begin = 3, .end = 6, .length = 3, .character = Nucleotide::T}};
  EXPECT_ARR_EQ(expected, actual)
}
