...
/// Configuration for recombinant detection strategy: multi-ancestor analysis
#[derive(Clone, Debug, Default, Eq, PartialEq, Serialize, Deserialize, schemars::JsonSchema, Validate)]
#[serde(rename_all = "camelCase")]
#[serde(default)]
#[schemars(example = "QcRecombConfigMultiAncestor::example")]
pub struct QcRecombConfigMultiAncestor {
  pub enabled: bool,
  pub weight: OrderedFloat<f64>,
  pub num_segments: usize,
...
impl QcRecombConfigMultiAncestor {
  pub const fn example() -> Self {
    Self {
      enabled: false,
      weight: OrderedFloat(50.0),
