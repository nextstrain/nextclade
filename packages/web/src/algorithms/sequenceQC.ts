import type { QCDiagnostics, QCResult, ClusteredSNPs, NucleotideLocation, NucleotideDeletion } from './types'
...
function findSNPClusters(mutations: NucleotideLocation[]) {
