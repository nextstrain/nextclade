...
Quick Example:
 ...
 2. Run:
    nextalign --sequences=sequences.fasta --reference=reference.txt --genemap=genemap.gff --genes=E,M,N,ORF10,ORF14,ORF1a,ORF1b,ORF3a,ORF6,ORF7a,ORF7b,ORF8,ORF9b,S --output-dir=output/ --output-basename=nextalign
